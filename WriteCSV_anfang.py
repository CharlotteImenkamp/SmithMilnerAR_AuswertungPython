    ...
    for eo in objects_time:
        ...
        if e[0] == str(eo[0]).replace('.', ','): # time of object positions gets shortened to gaze time
            rows.append({'Time': tim[count][0], 'Gaze_Origin_x': orig[count][0], 'Gaze_Origin_y': orig[count][1],
                         ...
                         'ObjectFile': string,
                         f'{objects[0]}_x': positions[objects[0]][obj_count][0],
                         ...
                         f'{objects[1]}_x': positions[objects[1]][obj_count][0],
                         ...
                         f'{objects[2]}_x': positions[objects[2]][obj_count][0],
                         ...
                         f'{objects[3]}_x': positions[objects[3]][obj_count][0],
                         f'{objects[3]}_y': positions[objects[3]][obj_count][1],
                         f'{objects[3]}_z': positions[objects[3]][obj_count][2],
                         ...
                         f'{objects[4]}_x': positions[objects[4]][obj_count][0],
                         ...
                         f'{objects[5]}_x': positions[objects[5]][obj_count][0],
                         ...
                         f'{objects[6]}_x': positions[objects[6]][obj_count][0],
                         ...
                         f'{objects[7]}_x': positions[objects[7]][obj_count][0],
                         ...
                         f'{objects[8]}_x': positions[objects[8]][obj_count][0],
                         ...
                         f'{objects[9]}_x': positions[objects[9]][obj_count][0],
                         ...
                         f'{objects[10]}_x': positions[objects[10]][obj_count][0],
                         ...
                         f'{objects[11]}_x': positions[objects[11]][obj_count][0],
                         ...
                         f'{objects[12]}_x': positions[objects[12]][obj_count][0],
                         ...
                         f'{objects[13]}_x': positions[objects[13]][obj_count][0],
                         ...
                         f'{objects[14]}_x': positions[objects[14]][obj_count][0],
                         ...
                         f'{objects[15]}_x': positions[objects[15]][obj_count][0],
                         ...
                         f'{objects[15]}_rot_w': rotations[objects[15]][obj_count][3]})
